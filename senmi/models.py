...
class PricingConfig(models.Model):
    ...
    base_fee = models.DecimalField(max_digits=10,decimal_places=2,default=1200)
    per_km_rate = models.DecimalField(max_digits=10,decimal_places=2,default=220)
    fuel_multiplier = models.DecimalField(max_digits=5,decimal_places=2,default=1.00)
